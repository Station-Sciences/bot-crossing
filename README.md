...
| **[Codex](https://developers.openai.com/codex/cli)** (OpenAI) | ✅ **Supported** — CLI and IDE extension, including git branch, live-turn detection and error state. No deep link or archive: Codex has neither |
