 ...
 * exists because a URL scheme is only as good as the app's handler for it — Cursor's opens
 * the app and not the folder, while its command line does exactly the right thing.
 */
